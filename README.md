# 👋 Hi, I'm Fan - AI Application Developer

> 4年前端工程经验，现专注 **AI 全栈应用开发**，能独立交付大模型驱动的智能产品。

## 🚀 代表项目

### 📚 [RAG 知识库问答系统](https://github.com/Fan-tasticDev/rag-knowledge-bot.git)
...
- **AI 大模型**：GPT系列, 智谱 GLM, DeepSeek, Qwen（API 集成与本地部署）
- **向量数据库**：Chroma, Milvus
- **Agent 框架**：LangChain, LlamaIndex, 原生 Function Calling
- **工程化**：Git, Docker, CI/CD (Vercel/Railway)

## 📫 求职意向
**大模型应用开发 / AI 前端工程师**  
欢迎通过邮件(fnh18338975065@163.com)联系我。
